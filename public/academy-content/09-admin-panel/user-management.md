...
The user table includes the following details:
...
Each user row contains an **action menu (three dots)** on the right side.

By clicking this menu, administrators can change the user's role.
