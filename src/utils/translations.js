export const staticTranslations = {
  en: {
    ...
    "dashboard_description_p1": "Create business plans step by step with the ",
    "hiw_advanced_details_pre": "PESTEL, Porter's Five Forces, NPS, BCG, ",
    "hiw_advanced_details_post": " scorecard",
    "dashboard_description_p2": " framework. Activate AI capabilities for analysis, prediction, and decision-making.",
    ...
    "cash_reserves_and_flows": "Cash Reserves & Flows",
    ...
    'Rank_Your_Projects': 'Rank Your Bets',
    'view_all_projects': 'View All Projects',
    'project_details': 'Project Details',
    'Hide_Rank_Projects': 'Hide Rank Bets',
    ...
    'Business_Decision_Logs': 'Business Decision Logs',
    'All_Projects': 'All Projects',
    'All_Decision_Logs': 'All Decision Logs',
    'entries': 'entries',
    'From_Date': 'From Date',
    'To_Date': 'To Date',
    'Log_Type': 'Log Type',
    'Failed_to_load_decision_logs': 'Failed to load decision logs. Please try again.',
    'No_logs_match_filters': 'No decision logs match the current filters.',
    'No_decision_logs_available': 'No decision logs available yet.',
    'Decision': 'Decision',
    'Actor': 'Actor',
    'Date': 'Date',
    'Sort': 'Sort',
    'Decision_Log_Details': 'Decision Log Details',
    'Execution_State': 'Execution State',
    'Assumption_State': 'Assumption State',
    'Before': 'Before',
    'After': 'After',
    ...
    "Drag projects to reorder. AI suggested an initial order.": 'Drag bets to reorder. AI suggested an initial order.',
  ...
  es: {
    'audit_login_success_company': 'Inicio de sesión exitoso como {{role}} en la empresa {{company}}',
    'audit_login_success': 'Inicio de sesión exitoso como {{role}}',
    'audit_login_failed': 'Intento de inicio de sesión fallido para {{email}}',
    'audit_logout': 'El usuario cerró sesión',
    'audit_question_answered_business': 'Pregunta respondida para el negocio: {{business}}',
    'audit_question_answered': 'Pregunta respondida',
    'audit_question_skipped_business': 'Pregunta omitida para el negocio: {{business}}',
    'audit_question_skipped': 'Pregunta omitida',
    'audit_question_edited_business': 'Pregunta editada para el negocio: {{business}}',
    'audit_question_edited': 'Pregunta editada',
    'audit_analysis_generated': '{{type}} generado: {{name}}',
    'audit_business_created': 'Negocio creado: {{business}}',
    'audit_business_deleted_convs': 'Negocio eliminado: {{business}} ({{count}} conversaciones eliminadas)',
    'audit_business_deleted': 'Negocio eliminado: {{business}}',
    'audit_collaborator_assigned': 'Colaborador asignado al negocio: {{business}}',
    ...
    "liquidity_ratios": "Ratios de Liquidez",
    "cash_reserves_and_flows": "Reservas y Flujos de Efectivo",
    ...
    'View_Justification': 'Ver Justificación',
    'Confirm_No_Changes': 'Confirmar Sin Cambios Requeridos',
    'Decision_Log': 'Registro de Decisiones',
    'Decision_Logs': 'Registros de Decisiones',
    'Business_Decision_Logs': 'Registros de Decisiones del Negocio',
    'All_Projects': 'Todos los Proyectos',
    'All_Decision_Logs': 'Todos los Registros de Decisiones',
    'entries': 'entradas',
    'From_Date': 'Desde',
    'To_Date': 'Hasta',
    'Log_Type': 'Tipo de Registro',
    'Failed_to_load_decision_logs': 'Error al cargar los registros de decisiones. Por favor, inténtalo de nuevo.',
    'No_logs_match_filters': 'No hay registros de decisiones que coincidan con los filtros actuales.',
    'No_decision_logs_available': 'Aún no hay registros de decisiones disponibles.',
    'Decision': 'Decisión',
    'Actor': 'Actor',
    'Date': 'Fecha',
    'Sort': 'Ordenar',
    'Decision_Log_Details': 'Detalles del Registro de Decisiones',
    'Execution_State': 'Estado de Ejecución',
    'Assumption_State': 'Estado de Suposición',
    'Before': 'Antes',
    'After': 'Después',
