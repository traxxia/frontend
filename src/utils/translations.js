export const staticTranslations = {
  en: {
    ...
    "step": "Step",
    "got_it": "Got It!",
    "pmf_onboarding": "PMF Onboarding",
    "company_client_name": "Company / Client Name",
    "enter_company_name": "Enter company or client name",
    "website": "Website",
    "company_name_required": "Company / Client Name is required",
    ...
    "which_geographies_strategic_answers": "Which geographies do you want strategic answers for?",
    "enter_up_to_3_geographies": "Enter up to 3 specific geographies (e.g., 'United States', 'LATAM', 'Southeast Asia')",
    "geography": "Geography",
    "enter_geography": "Enter geography",
    "where_does_profit_come_from": "Where does most of your profit come from today?",
    "your_best_estimate_enough": "Your best estimate is sufficient.",
    "customer_segments_max_3": "Customer segments (max. 3)",
    "customer_segments_example": "e.g., young adults, SMEs, enterprises",
    "products_services_max_3": "Products / services (max. 3)",
    "products_services_example": "e.g., ice cream, M&A consulting",
    "segment": "Segment",
    "product_service": "Product/Service",
    "channels_max_3":"Channels (max 3)",
    "channels_example":"e.g., convenience stores, direct sales",
    "geographies_max_3":"Geographies (max 3)",
    "geographies_example":"e.g., Lima, nationwide",
    ...
    'Key_Assumptions': 'Key Assumptions',
    'more': 'more',
    'Strategic_Decision_Placeholder': 'Describe the strategic bet or the core decision this project is testing...',
    'Owner_Placeholder': 'Assign a single accountable owner...',
    'Assumption_Placeholder': 'Assume',
    'Success_Criteria_Placeholder': 'What does success look like? (e.g., 20% increase in conversion)',
    'Kill_Criteria_Placeholder': 'When should we stop? (e.g., cost exceeds $10k without results)',
    'Select_Review_Cadence': 'Select Review Cadence',
    'Learning_State': 'Learning State',
    'Select_Learning_State': 'Select Learning State',
    'Select_Status': 'Select Status',
    'Select_Impact': 'Select Impact',
    'Select_Effort': 'Select Effort',
    'Select_Risk': 'Select Risk',
    'Select_Strategic_Theme': 'Select Strategic Theme',
    'Constraints_Placeholder': 'List non-negotiable constraints...',
    'Scope_Placeholder': 'Clearly state what is NOT included...',
    'Outcome_Placeholder': 'Describe the expected end result...',
    'Success_Metrics_Placeholder': 'How will you measure success? (e.g., +20% revenue)',
    'Timeline_Placeholder': 'e.g., 3–6 months',
    'Budget_Placeholder': 'e.g., $50K - $100K',
    'Dependencies_Placeholder': 'List any dependencies on other projects or systems...',
    'Milestone_based': 'Milestone-based',
    'No_project_data': 'No project data available.',
    'Back_to_Projects': 'Back to Projects',
    'Not_Available': 'N/A',
    'No_description_provided': 'No description provided',
    'No_Impact': 'No Impact',
    'Project_Name_Placeholder': 'Strategic Decision / Bet name...',
    'Project_Description_Placeholder': 'Summarize the core initiative and objective...',
    'Strategic_Decision_Placeholder': 'What specific strategic choice or "bet" are we making? e.g., "Pivot to SaaS first model"',
    'Why_This_Matters_Placeholder': 'Explain why this project is strategically important to the business (minimum 10 characters)',
    'No_projects_found': 'No projects found in this category',
    'New_Strategic_Bet': 'New Strategic Bet',
    'Edit_Strategic_Bet': 'Edit Strategic Bet',
    'View_Strategic_Bet': 'View Strategic Bet',
    'Strategic_Decision_Sublabel': 'What strategic choice are you operationalizing? (2-3 lines)',
    'Key_Assumptions_Sublabel': 'What must be true for this to succeed? (Max 3)',
    'Continue_If_Label': 'Continue if...',
    'Continue_If_Sublabel': 'Define success criteria (time-bound, e.g., \'90-day checkpoint shows 10% improvement\')',
    'Stop_If_Label': 'Stop or Pivot if...',
    'Stop_If_Sublabel': 'When should we kill or pivot this bet?',
    'Strategic_Decision_Bet': 'Strategic Decision / Bet',
    'Key_Assumptions_Tested': 'Key Assumptions Being Tested',
  },
  ...
  es: {
    ...
    "next": "Siguiente",
    "back": "Atrás",
    "finish": "Incorporación completa",
    "step": "Paso",
    "got_it": "¡Entendido!",
    "pmf_onboarding": "Incorporación PMF",
    "company_client_name": "Nombre de la Empresa / Cliente",
    "enter_company_name": "Ingresa el nombre de la empresa o cliente",
    "website": "Sitio Web",
    "company_name_required": "El nombre de la empresa / cliente es obligatorio",
    "where_is_business_based": "¿Dónde se encuentra principalmente este negocio?",
    "select_country": "Seleccionar país",
    "country_required": "El país es obligatorio",
    "primary_industry": "Industria Principal",
    "select_industry": "Seleccionar industria",
    "primary_industry_required": "La industria principal es obligatoria",
    "which_geographies_strategic_answers": "¿Para qué geografías desea respuestas estratégicas?",
    "enter_up_to_3_geographies": "Ingrese hasta 3 geografías específicas (ej., 'Estados Unidos', 'LATAM', 'Sudeste Asiático')",
    "geography": "Geografía",
    "enter_geography": "Ingrese geografía",
    "where_does_profit_come_from": "¿De dónde proviene la mayor parte de sus ganancias hoy?",
    "your_best_estimate_enough": "Su mejor estimación es suficiente.",
    "customer_segments_max_3": "Segmentos de clientes (máx. 3)",
    "customer_segments_example": "ej., adultos jóvenes, PYMEs, empresas",
    "products_services_max_3": "Productos / servicios (máx. 3)",
    "products_services_example": "ej., helados, asesoría en fusiones y adquisiciones",
    "segment": "Segmento",
    "product_service": "Producto/Servicio",
    "channels_max_3":"Canales (máx 3)",
    "channels_example":"p. ej., tiendas de conveniencia, ventas directas",
    "Channel 1":"Canal 1",
    "Channel 2":"Canal 2",
    "Channel 3":"Canal 3",
    "Geography 1":"Geografía 1",
    "Geography 2":"Geografía 2",
    "Geography 3":"Geografía 3",
    "Key challenges / constraints":"Desafíos clave / restricciones",
    "Today, you primarily differentiate through":"Hoy en día, la diferenciación se produce principalmente a través de",
    "Select up to":"Seleccione hasta",
    "Usage Context":"Contexto de uso",
    "AHA_Insights":"Insights AHA",
  ...
  'Note_desc':'Esta es una herramienta de priorización estratégica, no un sistema de gestión de proyectos. Úsala para decidir en qué trabajar y luego gestiona la ejecución en la herramienta de gestión de proyectos de tu elección.',
    ...
    'Key_Assumptions': 'Suposiciones Clave',
    'more': 'más',
    'Strategic_Decision_Placeholder': 'Describe la apuesta estratégica o la decisión central que este proyecto está probando...',
    'Owner_Placeholder': 'Asigna un único propietario responsable...',
    'Assumption_Placeholder': 'Asumir',
    'Success_Criteria_Placeholder': '¿Cómo es el éxito? (ej. aumento del 20% en conversión)',
    'Kill_Criteria_Placeholder': '¿Cuándo detenerse? (ej. el costo supera los $10k sin resultados)',
    'Select_Review_Cadence': 'Seleccionar Cadencia de Revisión',
    'Learning_State': 'Estado de Aprendizaje',
    'Select_Learning_State': 'Seleccionar Estado de Aprendizaje',
    'Select_Status': 'Seleccionar Estado',
    'Select_Impact': 'Seleccionar Impacto',
    'Select_Effort': 'Seleccionar Esfuerzo',
    'Select_Risk': 'Seleccionar Riesgo',
    'Select_Strategic_Theme': 'Seleccionar Tema Estratégico',
    'Constraints_Placeholder': 'Lista las restricciones no negociables...',
    'Scope_Placeholder': 'Indica claramente lo que NO está incluido...',
    'Outcome_Placeholder': 'Describe el resultado final esperado...',
    'Success_Metrics_Placeholder': '¿Cómo medirás el éxito? (ej. +20% ingresos)',
    'Timeline_Placeholder': 'ej. 3–6 meses',
    'Budget_Placeholder': 'ej. $50K - $100K',
    'Dependencies_Placeholder': 'Lista cualquier dependencia de otros proyectos o sistemas...',
    'Milestone_based': 'Por hitos',
    'No_project_data': 'No hay datos del proyecto disponibles.',
    'Back_to_Projects': 'Volver a Proyectos',
    'Not_Available': 'N/D',
    'No_description_provided': 'No se proporcionó descripción',
    'No_Impact': 'Sin Impacto',
    'Project_Name_Placeholder': 'Nombre de la decisión estratégica / apuesta...',
    'Project_Description_Placeholder': 'Resuma la iniciativa central y el objetivo...',
    'Why_This_Matters_Placeholder': 'Explica por qué este proyecto es estratégicamente importante para el negocio (mínimo 10 caracteres)',
    'No_projects_found': 'No se encontraron proyectos en esta categoría',
    'New_Strategic_Bet': 'Nueva Apuesta Estratégica',
    'Edit_Strategic_Bet': 'Editar Apuesta Estratégica',
    'View_Strategic_Bet': 'Ver Apuesta Estratégica',
    'Strategic_Decision_Sublabel': '¿Qué elección estratégica está operacionalizando? (2-3 líneas)',
    'Key_Assumptions_Sublabel': '¿Qué debe ser cierto para que esto tenga éxito? (Máx 3)',
    'Continue_If_Label': 'Continuar si...',
    'Continue_If_Sublabel': 'Definir criterios de éxito (limitados en el tiempo, ej. \'el punto de control de 90 días muestra una mejora del 10%\')',
    'Stop_If_Label': 'Detener o Pivotar si...',
    'Stop_If_Sublabel': '¿Cuándo deberíamos cancelar o pivotar esta apuesta?',
    'Strategic_Decision_Bet': 'Decisión Estratégica / Apuesta',
    'Key_Assumptions_Tested': 'Suposiciones Clave Probadas',
  }
};
