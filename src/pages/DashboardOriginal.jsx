...
const DashboardOriginal = () => {
  ...
  const DeleteButtonAlternatives = ({ business, viewType, canDelete = true }) => {
    ...
    const SimpleDeleteButton = () => {
      if (isViewer) return null; // ≡ƒæê HIDE FOR VIEWER
          ...
          <small className="text-muted">
            ...
            {remainingQuestions > 0 && (
              <span className="text-warning ms-2">
                ΓÇó {remainingQuestions} {t('questions_remaining')}
              </span>
            )}
          </small>
        </div>
              ...
              {businessToDelete && (
                <div>
                  ...
                  <div className="alert alert-danger mb-3">
                    <h6 className="alert-heading mb-2">ΓÜá∩╕Å {t('This_will_permanently_delete')}</h6>
                    <ul className="mb-2">
