    ...
    return `
      ...
      ">
        ...
        <div style="
          ...
          font-size: 12px;
        ">
          <p style="margin: 5px 0;">This report was generated by Traxia AI - Your Strategic Business Advisor</p>
          <p style="margin: 5px 0;">© ${currentDate.getFullYear()} Traxia AI. All rights reserved.</p>
