...
import { TrendingUp, Target, Puzzle, AlertCircle } from "lucide-react";
...
const PMFInsights = ({
  ...
  if (loading) {
    return <div className="bg-light py-5 min-vh-100 d-flex justify-content-center align-items-center">
  ...
  return <div className="bg-light py-5 min-vh-100">
      <StyleSheet />
      <Container className="p-m-f-insights--s1">
        <div className="text-center mb-5">
          ...
          <p className="text-muted fs-6">
            {insights.length > 0 ? t("Based on your inputs, here are the critical insights about your strategic position.") : t("No specific insights found for your inputs. Please check your onboarding data.")}
          </p>
        </div>
                  ...
                  <Card className="h-100 border-0 shadow-sm rounded-4">
                    <Card.Body className="p-4">
                      <div className="d-flex align-items-start gap-3">
                        <div className="icon-box d-flex align-items-center justify-content-center bg-primary-subtle rounded-3 p-m-f-insights--s2">
                        ...
                        <div>
                          ...
                          <ul className="insight-list mb-0 p-m-f-insights--s3">
        ...
        <div className="d-flex justify-content-center mt-5">
          <Button size="lg" className="px-5 rounded-3 fw-semibold" onClick={onContinue}>
            {t("Continue")}
          </Button>
        </div>
      </Container>
