...
{renderStrategicRecommendationsFromAnalyses()}
  ...
  const renderStrategicContent = () => {
    ...
    const recommendations = analysisData?.strategic_recommendations; if (!recommendations) return null;
    ...
    return (
      <div className="strategic-content">
        {recommendations.strategy_block && (
          <CategorySection
            id="strategy-block"
            title="Strategy Block: Direction & Positioning"
            icon={Target}
        ...
        {recommendations.execution_block && (
          <CategorySection
            id="execution-block"
            title="Execution Block: Implementation & Monitoring"
            icon={CheckCircle}
        ...
        {recommendations.sustainability_block && (
          <CategorySection
            ...
            title="Sustainability Block: Long-term Reinforcement"
            icon={Shield}
