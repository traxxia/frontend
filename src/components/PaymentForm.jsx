...
const getBrandIcon = brand => {
  switch (brand) {
    ...
    case 'discover':
      return <FaCcDiscover size={40} />;
    case 'diners':
      return <FaCcDinersClub size={40} />;
    case 'jcb':
      return <FaCcJcb size={40} />;
    default:
...
const PaymentForm = ({
  ...
  return <div className="payment-form-container">
            <div className="full-width-field payment-section payment-form--s1">
                ...
                {paymentMethodType === 'card' && isActive && <motion.div ref={cardDetailsRef} initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
        duration: 0.3
                        ...
                        {}
                        <AnimatePresence>
                            {cardComplete && <motion.div initial={{
            opacity: 0,
            height: 0,
            marginBottom: 0
          }} animate={{
            ...
            stiffness: 300,
            damping: 30
          }} className="visual-card-wrapper payment-form--s2">
  ...
  <span className="meta-value">MM/YY</span>
                        ...
                        <div className="form-group mb-3">
                            ...
                            <div className="stripe-input-wrapper">
                                <input type="text" placeholder={t("Card Holder Name")} value={cardHolderName} onChange={e => onCardHolderNameChange && onCardHolderNameChange(e.target.value)} disabled={isSubmitting} style={{
              color: isSubmitting ? '#aab7c4' : '#424770',
              cursor: isSubmitting ? 'not-allowed' : 'text'
            }} className="payment-form--s3" />
                            </div>
                        </div>
