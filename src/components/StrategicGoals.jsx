        ...
        try {
            ...
            if (response.ok) {
                ...
                if (result.missing_count > 0) {
                    ...
                    // Create a custom result to highlight the strategicGoals question(s)
                    const strategicGoalsQuestions = await fetch(
                        ...
                        data.questions.filter(q => q.used_for && q.used_for.includes('strategicGoals'))
                    );

                    handleRedirectToBrief({
                        missing_count: strategicGoalsQuestions.length,
                        missing_questions: strategicGoalsQuestions.map(q => ({
                            _id: q._id,
                            order: q.order,
                        ...
                        analysis_type: 'strategicGoals',
                        message: `Please provide more detailed answers for strategic goals analysis. The current answers are insufficient to generate meaningful strategic objectives and OKRs.`,
                        is_complete: false,
                ...
                handleRedirectToBrief({
                    ...
                    missing_questions: [],
                    analysis_type: 'strategicGoals',
                    message: 'Please review and improve your answers for strategic goals analysis.'
                });
            }
        } catch (error) {
        ...
        return (
            <div className="strategic-goals-container">
                ...
                <MissingQuestionsChecker
                    analysisType="strategicGoals"
                    analysisData={strategicGoalsData}
